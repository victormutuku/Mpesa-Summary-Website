    ...
    return (
        <div className='w-full flex justify-center'>
            <div className="flex flex-col items-center justify-center pt-20 px-5 max-w-225">
                ...
                <p className='text-2xl font-medium lg:px-20 mb-4 text-magnolia-950'>Terms and Conditions</p>
                <p className="mb-6 text-magnolia-950"><span className="font-semibold">Effective Date:</span> 6th April 2026</p>
                <div className="lg:px-20">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">2. ELIGIBILITY</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">3. DESCRIPTION OF THE SERVICE</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">4. SUBSCRIPTIONS</p>
                    <div className="flex flex-col gap-2 mb-8">
                        <p className='font-semibold text-magnolia-950'>4.1 Subscription Plans</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>4.2 Billing and Payment</p>
                        <p>Subscription fees are charged in advance at the start of each billing period. Payment is processed by Google Play Store and is subject to the <a href="https://play.google.com/about/play-terms/" rel='noreferrer' className='underline text-magnolia-950'>Google Play Terms of Service</a>.</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>4.3 Automatic Renewal</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>4.4 Cancellation</p>
                        <p>You may cancel your Premium Plan subscription at any time through the Google Play Store subscriptions management page. Instructions on how to cancel can be found at <a href="support.google.com/googleplay" rel='noreferrer' className='underline text-magnolia-950'>support.google.com/googleplay</a>.</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>4.5 Refunds</p>
                        <p>As payments are processed by Google Play Store, all refund requests are subject to the <a href="https://support.google.com/googleplay/answer/2479637" rel='noreferrer' className='underline text-magnolia-950'> Google Play refund policy</a>. We do not process refunds directly.</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>4.6 Price Changes</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>4.7 Suspension and Termination of Subscription</p>
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">5. PERMISSIONS AND DATA ACCESS</p>
                    <div className="flex flex-col gap-2 mb-8">
                        <p className='font-semibold text-magnolia-950'>5.1 SMS Access</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>5.2 Scope of Access</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>5.3 Notification Access</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>5.4 On-Device Processing</p>
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">6. PRIVACY AND DATA PROTECTION</p>
                    <div className="flex flex-col gap-2 mb-8">
                        ...
                        <p className='font-semibold mt-2 text-magnolia-950'>6.1 Data Collected</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>6.2 Purpose of Processing</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>6.3 Data Storage</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>6.4 Your Rights</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>6.5 Data Retention</p>
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">7. USER OBLIGATIONS</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">8. INTELLECTUAL PROPERTY</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">9. ACCURACY OF SUMMARIES</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">10. THIRD-PARTY SERVICES</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">11. DISCLAIMER OF WARRANTIES</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">12. LIMITATION OF LIABILITY</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">13. TERMINATION</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">14. CHANGES TO THESE TERMS</p>
                    <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">15. GOVERNING LAW AND DISPUTE RESOLUTION</p>
                    <div className="flex flex-col gap-2 mb-8">
                        <p>These Terms are governed by the laws of the Republic of Kenya.</p>

                        <p className='font-semibold mt-2 text-magnolia-950'>15.1 Good-Faith Negotiation</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>15.2 Mediation</p>
                        ...
                        <p className='font-semibold mt-4 text-magnolia-950'>15.3 Litigation</p>
                    ...
                    <p className="font-semibold mb-4 text-magnolia-950">16. CONTACT INFORMATION</p>
                    <div className="flex flex-col gap-2 mb-8">
                        ...
                        <p className='mt-4 font-semibold text-magnolia-950'>These Terms and Conditions constitute the entire agreement between you and {companyName} with respect to your use of SpendAnalysis.</p>
                    </div>
                </div>
            </div>
        </div>
