...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center px-5 bg-magnolia-50 text-magnolia-950">
        <div className="h-screen flex flex-col items-center justify-center">
          <Image src="/images/icon.png" width={250} height={250} alt="App Icon" />
          <p className="font-medium text-5xl tracking-wide -mt-3 pb-10 text-magnolia-950">SpendAnalysis</p>
          <a href={downloadLink} className="border-2 my-5 py-4 px-12 rounded-lg font-medium text-lg cursor-pointer text-magnolia-950">Download</a>
        </div>
        <div className="max-w-[900px] flex flex-col items-center pb-10">
          ...
          <div className="text-xl font-light">
            <ol>
              <li className="mb-2 list-decimal">Download the application by clicking the <a href={downloadLink} className="text-magnolia-800 underline">download</a> button.</li>
            ...
            <ul className="w-full text-left mb-5">
              ...
              <li className="list-disc list-inside mb-2">The following popup will appear. Click <span className="font-medium">Pause</span>.</li>
